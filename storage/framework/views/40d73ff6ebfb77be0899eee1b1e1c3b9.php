                    ...
                    <div class="mt-6">
                        <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                            ...
                            <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                                <?php $__empty_1 = true; $__currentLoopData = $patienten; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $patient): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        <td class="px-6 py-4 whitespace-normal break-words text-sm text-gray-900 dark:text-gray-100">
                                            <?php echo e($patient->Nummer); ?>

                                        </td>

                                        <td class="px-6 py-4 whitespace-normal break-words text-sm text-gray-900 dark:text-gray-100">
                                            <?php echo e($patient->Naam); ?>

                                        </td>

                                        <td class="px-6 py-4 whitespace-normal break-words text-sm text-gray-900 dark:text-gray-100">
                                            <?php echo e($patient->MedischDossier); ?>

                                        </td>

                                        <td class="px-6 py-4 whitespace-normal break-words text-sm text-gray-900 dark:text-gray-100">
                                            <form action="<?php echo e(route('factuur.create')); ?>" method="GET">
                                                <?php echo csrf_field(); ?>
                                                <input type="hidden" name="patient_id" value="<?php echo e($patient->PatientId); ?>">
                                                <button type="submit"
...
<?php endif; ?>
<?php /**PATH /home/hamid/phpprojecten/SmilePro/resources/views/patienten/overzicht-patienten.blade.php ENDPATH**/ ?>