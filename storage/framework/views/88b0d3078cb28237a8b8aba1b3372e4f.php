...
<body class="min-h-screen bg-gray-900 mt-20">
    ...
    <div class="mx-auto max-w-xl text-center">
        ...
        <div class="mt-8 flex items-center justify-center gap-x-4">
            ...
            <img src="<?php echo e(asset('img/smilepro-logo.png')); ?>" alt="SmilePro-logo" class="mx-auto h-25 w-auto" />
    </div>
...
<?php /**PATH /home/hamid/phpprojecten/SmilePro/resources/views/welcome.blade.php ENDPATH**/ ?>